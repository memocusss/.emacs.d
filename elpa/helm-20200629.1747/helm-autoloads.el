...
\(fn PROMPT COLLECTİON &key TEST İNİTİAL-İNPUT DEFAULT PRESELECT (BUFFER \"*Helm Completions*\") MUST-MATCH FUZZY REVERSE-HİSTORY (REQUİRES-PATTERN 0) HİSTORY İNPUT-HİSTORY (CASE-FOLD helm-comp-read-case-fold-search) (DEL-İNPUT t) (PERSİSTENT-ACTİON nil) (PERSİSTENT-HELP \"DoNothing\") (MODE-L0NE helm-comp-read-mode-line) HELP-MESSAGE (KEYMAP helm-comp-read-map) (NAME \"Helm Completions\") HEADER-NAME CANDİDATES-İN-BUFFER MATCH-PART MATCH-DYNAMİC EXEC-WHEN-ONLY-ONE QUİT-WHEN-NO-CAND (VOLATİLE t) SORT FC-TRANSFORMER HİST-FC-TRANSFORMER MARKED-CANDİDATES NOMARK (ALİSTP t) (CANDİDATE-NUMBER-LİMİT helm-candidate-number-limit) MULTİLİNE ALLOW-NEST COERCE (GROUP \\='helm))" nil nil)
