...
\(fn SERVER-COMMAND NOTEBOOK-DİRECTORY &optional NO-LOGİN-P LOGİN-CALLBACK PORT)" t nil)
...
\(fn &optional NBLİST RESYNC CALLBACK)" t nil)
...
\(fn URL-OR-PORT CALLBACK &optional COOKİE-PLİST TOKEN)" t nil)
